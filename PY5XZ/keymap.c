...
#define DUAL_FUNC_1 LT(8, KC_F14)
#define DUAL_FUNC_2 LT(6, KC_9)
#define DUAL_FUNC_3 LT(4, KC_1)
#define DUAL_FUNC_4 LT(4, KC_B)
#define DUAL_FUNC_5 LT(11, KC_1)
#define DUAL_FUNC_6 LT(11, KC_F6)
#define DUAL_FUNC_7 LT(12, KC_F15)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LCTL(KC_C),     KC_W,           KC_C,           KC_L,           KC_D,           KC_G,                                           KC_ESCAPE,      KC_U,           KC_O,           KC_Y,           KC_Z,           LCTL(KC_V),     
                                                    LT(1, KC_R),    LT(3, KC_ENTER),                                OSL(2),         LT(5, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
