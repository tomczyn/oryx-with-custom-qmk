...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_NO,          KC_W,           KC_C,           KC_L,           KC_D,           KC_G,                                           KC_ENTER,       KC_U,           KC_O,           KC_Y,           KC_Z,           KC_NO,          
